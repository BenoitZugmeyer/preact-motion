...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo = (function (_Component) {
	  ...
	  Demo.prototype.handleMouseDown = function handleMouseDown() {
	    this.setState({ open: !this.state.open });
	  };
	
	  Demo.prototype.handleTouchStart = function handleTouchStart(e) {
	    e.preventDefault();
	        ...
	        function (_ref) {
	          ...
	          return(
	            ...
	            _preact.h(
	              'div',
	              { className: 'demo0' },
	              _preact.h('div', { className: 'demo0-block', style: {
