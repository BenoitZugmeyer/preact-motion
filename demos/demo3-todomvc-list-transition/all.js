...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo = (function (_Component) {
	  ...
	  Demo.prototype.handleChange = function handleChange(_ref2) {
	    var value = _ref2.target.value;
	
	    this.setState({ value: value });
	  };
	
	  Demo.prototype.handleSubmit = function handleSubmit(e) {
	    e.preventDefault();
	    var newItem = {
	      key: 't' + Date.now(),
	  ...
	  Demo.prototype.handleDone = function handleDone(doneKey) {
	    this.setState({
	  ...
	  Demo.prototype.handleToggleAll = function handleToggleAll() {
	  ...
	  Demo.prototype.handleSelect = function handleSelect(selected) {
	    this.setState({ selected: selected });
	  };
	
	  Demo.prototype.handleClearCompleted = function handleClearCompleted() {
	  ...
	  Demo.prototype.handleDestroy = function handleDestroy(date) {
	  ...
	  Demo.prototype.getDefaultStyles = function getDefaultStyles() {
	    return this.state.todos.map(function (todo) {
	      return _extends({}, todo, { style: { height: 0, opacity: 1 } });
	    });
	  };
	
	  Demo.prototype.getStyles = function getStyles() {
	    var _state = this.state;
	  ...
	  Demo.prototype.willEnter = function willEnter() {
	    return {
	      height: 0,
	      opacity: 1
	    };
	  ...
	  Demo.prototype.willLeave = function willLeave() {
	    return {
