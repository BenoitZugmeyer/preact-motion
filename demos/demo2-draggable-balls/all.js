...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo = (function (_Component) {
	  ...
	  Demo.prototype.handleTouchStart = function handleTouchStart(key, pressLocation, e) {
	  ...
	  Demo.prototype.handleMouseMove = function handleMouseMove(_ref) {
	    ...
	    var _state$mouseCircleDelta = _state.mouseCircleDelta;
	    var dx = _state$mouseCircleDelta[0];
	    var dy = _state$mouseCircleDelta[1];
	
	    if (isPressed) {
	      var mouseXY = [pageX - dx, pageY - dy];
	      var col = clamp(Math.floor(mouseXY[0] / width), 0, 2);
	      var row = clamp(Math.floor(mouseXY[1] / height), 0, Math.floor(count / 3));
	      var index = row * 3 + col;
	      var newOrder = reinsert(order, order.indexOf(lastPress), index);
	      this.setState({ mouseXY: mouseXY, order: newOrder });
	    }
	  };
	
	  Demo.prototype.handleMouseDown = function handleMouseDown(key, _ref2, _ref3) {
	    var pressX = _ref2[0];
	    var pressY = _ref2[1];
